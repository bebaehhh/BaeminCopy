			...
			<div class="margin_left_top">
				<div class="inline-b" style="margin-bottom: 25px;">
					...
					<ul class="ul-top-area">
						<li><a href="<c:url value="/mypage/myreview"/>" class="black small-font li-row">내가 작성한 리뷰 보기</a></li>
						<li class="orange primary small-font li-row"><em class="gray" style="font-weight: lighter;">|</em>작성 가능한 리뷰 보기</li>
					</ul>
				
				
				<div class="no-review">
					<img src="<c:url value="/img/img-noreview-write.png" />" style="width:40%;">
				</div>
			</div>
